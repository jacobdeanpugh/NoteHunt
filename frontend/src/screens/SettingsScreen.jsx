...
export default function SettingsScreen() {
  ...
  return (
    <div className="max-w-2xl">
      ...
      <div className="mb-8">
        <h2 className="text-xs uppercase text-[#555555] font-medium tracking-wide border-b border-[#1e1e1e] pb-2 mb-6">
          Directory Settings
        </h2>
          ...
          {Object.entries(formData.extensions).map(([ext, checked]) => (
            ...
            >
              <input
                ...
                className="w-4 h-4 bg-[#141414] border border-[#1e1e1e] rounded cursor-pointer"
              />
              <span className="font-mono text-sm text-[#aaaaaa]">.{ext}</span>
            </label>
          ))}
        </div>
      </div>
      ...
      {/* Note */}
      <p className="text-xs text-[#555555] mt-6 italic">
